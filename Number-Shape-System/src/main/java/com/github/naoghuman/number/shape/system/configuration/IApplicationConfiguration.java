 ...
 */
package com.github.naoghuman.number.shape.system.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/number/shape/system/application/application.properties"; // NOI18N

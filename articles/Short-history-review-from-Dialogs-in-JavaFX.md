Short history review from Dialogs in JavaFX
===
...
TODO add the intention
* Overview what happen in the topic `Dialog` in JavaFX 2.0 to JavaFX 8.
* starting situation
* Situation in JavaFX 2.0
* Situation in JavaFX 2.2
* Situation before JavaFX 8.0
* Situation in JavaFX 8.0
* A really special thanks to the community for the effort and patience. List with names.
...
<br />
##### PointTwo<a name="PointTwo" />

TODO add point two.


<br />
##### _PointThree_<a name="PointThree" />

TODO add point three.
...
* TODO This article series described how I ...

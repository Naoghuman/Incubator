 ...
 */
package com.github.naoghuman.lib.card.demo.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/lib/card/demo/application/application.properties"; // NOI18N

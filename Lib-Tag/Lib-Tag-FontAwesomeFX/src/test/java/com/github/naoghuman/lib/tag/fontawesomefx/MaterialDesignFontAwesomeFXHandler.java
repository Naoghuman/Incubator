 ...
 * @author Naoghuman
 */
public class MaterialDesignFontAwesomeFXHandler extends AbstractFontAwesomeFXHandler {

    @Override
    public GlyphsFactory getGlyphsFactory() {
        return MaterialDesignIconFactory.get();
    }

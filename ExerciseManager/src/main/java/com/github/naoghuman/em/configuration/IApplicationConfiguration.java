 ...
 */
package com.github.naoghuman.em.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/em/application/application.properties"; // NOI18N

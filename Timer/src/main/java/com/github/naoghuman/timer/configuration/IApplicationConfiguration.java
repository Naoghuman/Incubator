 ...
 */
package com.github.naoghuman.timer.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/timer/application/application.properties"; // NOI18N

 ...
 */
package com.github.naoghuman.background.chooser.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/background/chooser/application/application.properties"; // NOI18N

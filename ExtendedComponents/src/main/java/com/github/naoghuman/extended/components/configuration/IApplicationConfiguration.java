 ...
 */
package com.github.naoghuman.extended.components.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/extended/components/application/application.properties"; // NOI18N

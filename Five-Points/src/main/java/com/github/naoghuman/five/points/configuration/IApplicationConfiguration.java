 ...
 */
package com.github.naoghuman.five.points.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/five/points/application/application.properties"; // NOI18N

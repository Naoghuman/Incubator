 ...
 */
package com.github.naoghuman.shortcut.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/shortcut/application/application.properties"; // NOI18N

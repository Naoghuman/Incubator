...
public interface INavigationOverviewConfiguration {
    ...
    public static final String ON_ACTION__OPEN_PROJECT_IN_DAILY_SECTION = "ON_ACTION__OPEN_PROJECT_IN_DAILY_SECTION"; // NOI18N
    public static final String ON_ACTION__SHOW_NEW_DAILY_SECTION_DIALOG = "ON_ACTION__SHOW_NEW_DAILY_SECTION_DIALOG"; // NOI18N

...
public class GameInformationsManager implements IRegisterActions {
    ...
    private void initialize() {
        DebugConsole.getDefault().info(this.getClass(), "Initialize GameInformationsManager"); // NOI18N
        
        this.initializeGameInformations();
    }
    
    private void initializeGameInformations() {
        DebugConsole.getDefault().info(this.getClass(), "Initialize GameInformations"); // NOI18N

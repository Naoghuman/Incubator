 ...
 */
package com.github.naoghuman.decisions.configuration;
...
public interface IApplicationConfiguration {
    ...
    public static final String KEY__APPLICATION__RESOURCE_BUNDLE = "/com/github/naoghuman/decisions/application/application.properties"; // NOI18N
